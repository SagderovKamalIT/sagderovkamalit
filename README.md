<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:2563eb,100:7c3aed&height=200&section=header&text=Kamal%20Sagderov&fontSize=40&fontAlignY=35&desc=Frontend%20Developer%20%7C%20React&descAlignY=55&animation=fadeIn&fontColor=000000" />
</p>

<div align="center">

🚀 **Frontend Developer Intern (стажер)**, сфокусированный на экосистеме **React**  
Развиваюсь в направлении **React + TypeScript**, уделяю внимание архитектуре компонентов, качеству кода и современным UI‑решениям
...
<td>
<strong>React</strong> — компонентный подход, декомпозиция интерфейсов, переиспользуемые компоненты
</td>
</tr>
<tr>
<td valign="top" width="80px">
...
<td>
<strong>TypeScript</strong> — базовая и средняя типизация, интерфейсы, строгая типизация props
</td>
</tr>
<tr>
<td valign="top" width="80px">
...
<td>
<strong>Material UI (MUI)</strong> — адаптивные и консистентные интерфейсы
</td>
</tr>
<tr>
<td valign="top" width="80px">
<img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/javascript/javascript-original.svg" width="32" height="32" alt="SPA" />
</td>
<td>
<strong>SPA</strong> — маршрутизация, управление состоянием, работа с формами и API
</td>
</tr>
</table>
...
![Vite](https://img.shields.io/badge/Vite-646CFF?style=flat&logo=vite&logoColor=white)
![SCSS](https://img.shields.io/badge/SCSS%20Modules-CC6699?style=flat&logo=sass&logoColor=white)
...
<p align="center">
  <a href="https://t.me/kamal_sagderov" target="_blank">
    <img src="https://img.shields.io/badge/Telegram-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white" alt="Telegram" />
  </a>
  <a href="mailto:sagderovkamal.it@gmail.com">
...
⭐️ **Спасибо за интерес к моему профилю!**  
Открыт к профессиональному общению, фидбеку и новым возможностям 🤝
